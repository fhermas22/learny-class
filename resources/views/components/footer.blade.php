    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="flex gap-6">
                ...
                <a href="#" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-600 transition-colors duration-300">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 002.856-3.51 10 10 0 01-2.856.17 10 10 0 00-1.993-1.679c-.855-.604-1.772-1.13-2.744-1.566a10 10 0 01-.81 2.256 10 10 0 01-2.288-1.052 10 10 0 00-2.69 1.65 10.864 10.864 0 01-1.823 8.224 10 10 0 002.856 3.51 10 10 0 002.856-.17 10 10 0 001.993 1.679c.855.604 1.772 1.13 2.744 1.566a10 10 0 01.81-2.256 10 10 0 012.288 1.052 10 10 0 002.69-1.65 10.864 10.864 0 011.823-8.224z"></path></svg>
                </a>
                <a href="#" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-600 transition-colors duration-300">
